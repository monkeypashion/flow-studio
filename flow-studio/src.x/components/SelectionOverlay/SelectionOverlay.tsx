...
export const SelectionOverlay: React.FC<SelectionOverlayProps> = ({ containerRef }) => {
  ...
  const { selectClip, clearSelection, groups, timeline, selection } = useAppStore();
  ...
  useEffect(() => {
    ...
    const handleMouseDown = (e: MouseEvent) => {
      ...
      // Don't start selection if clicking on a clip, control, or track header
    ...
    const handleMouseMove = (e: MouseEvent) => {
          ...
          aspect.tracks.forEach(track => {
            track.clips.forEach(clip => {
              ...
              if (intersects) {
                ...
                console.log(`Clip ${clip.name} intersects:`, {
      ...
      console.log(`Checked ${totalClipsChecked} clips, ${clipsIntersected} intersected, selecting ${clipsToSelect.size} total`);
  ...
  }, [clearSelection, selectClip, groups, timeline, selection, containerRef]);
